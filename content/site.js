...
const SITE = {
  ...
  // ── HERO CAROUSEL ──────────────────────────
  hero: {
    badge:   "For Hotels · Restaurants · Cafés",
  ...
  about: {
    ...
    body: [
      "Swananda produces spray-dried functional mocktail premix powders designed for the HoReCa segment. Each formulation delivers café-quality drinks from a single sachet — no blenders, no fresh fruit prep, no skilled bartenders required.",
      "Our spray-drying process captures volatile flavour compounds with pharmaceutical precision, delivering the same perfect drink every time. Zero added sugar. Zero artificial colours. Ambient storage with a 12-month shelf life.",
      "From a boutique café serving 50 covers to a hotel running 500 — Swananda scales effortlessly with your operation."
    ],
    stats: [
